...
public class EventProCreationTest extends BaseWebTest implements EventTest {

    private final Authorizer authorizer = Authorizer.getInstance();

    // Create 'Event Pro' event model.
    ...
    @Test(
            testName = "Check Event Pro event creation",
            description = "'Event Pro' event can be created.",
            groups = {
                    ONE_USER,
                    EMI
            }
