...
public class LogInWithPartnerAccountWhenSecurityGroupIsAddedInEventTest extends BaseWebTest implements KeycloakEventTest {
    ...
    @Test(
            testName = "Log in with partner account when security group is added in event",
            description = "Keycloak user with Partner role can Log in to Event if it has Security Group.",
            groups = {
                    ONE_USER,
                    EVENT,
                    KEYCLOAK
