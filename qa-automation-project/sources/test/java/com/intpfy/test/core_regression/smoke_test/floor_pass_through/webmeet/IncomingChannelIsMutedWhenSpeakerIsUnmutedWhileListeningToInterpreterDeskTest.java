...
public class IncomingChannelIsMutedWhenSpeakerIsUnmutedWhileListeningToInterpreterDeskTest extends BaseWebTest implements WebRtcTest {
    ...
    @Test(
            testName = "Incoming channel is muted when speaker is unmuted while listening to interpreter desk",
            description = "Incoming channel is Muted when Speaker is Unmuted while listening to Interpreter desk.",
            groups = {
                    THREE_USERS,
