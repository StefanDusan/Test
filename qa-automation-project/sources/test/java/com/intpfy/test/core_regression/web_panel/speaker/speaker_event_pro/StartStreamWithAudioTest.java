...
public class StartStreamWithAudioTest extends BaseWebTest implements WebRtcTest {
    ...
    @Test(
            ...
            description = "Speaker can stream with Audio only in 'Event Pro' event.",
            groups = {
                    ONE_USER,
