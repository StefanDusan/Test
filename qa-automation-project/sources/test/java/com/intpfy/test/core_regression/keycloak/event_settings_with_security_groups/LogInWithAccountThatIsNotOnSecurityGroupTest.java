...
public class LogInWithAccountThatIsNotOnSecurityGroupTest extends BaseWebTest implements KeycloakEventTest {
    ...
    @Test(
            ...
            description = "Keycloak user without Partner role and not belonging to Security Group can not Log in to Event if it has Security Group.",
            groups = {
                    ONE_USER,
                    EVENT,
                    KEYCLOAK
