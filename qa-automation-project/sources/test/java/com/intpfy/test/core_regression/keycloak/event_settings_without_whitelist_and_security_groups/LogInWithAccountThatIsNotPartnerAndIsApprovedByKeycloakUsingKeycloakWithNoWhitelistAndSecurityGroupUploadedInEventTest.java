...
public class LogInWithAccountThatIsNotPartnerAndIsApprovedByKeycloakUsingKeycloakWithNoWhitelistAndSecurityGroupUploadedInEventTest
    ...
    @Test(
            testName = "Log in with account that is not partner and is approved by keycloak using keycloak, with no whitelist and security group uploaded in event",
