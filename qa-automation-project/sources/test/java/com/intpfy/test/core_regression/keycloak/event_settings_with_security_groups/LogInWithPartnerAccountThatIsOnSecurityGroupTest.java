...
public class LogInWithPartnerAccountThatIsOnSecurityGroupTest extends BaseWebTest implements KeycloakEventTest {
    ...
    @Test(
            ...
            description = "Keycloak user with Partner role and belonging to Security Group can Log in to Event if it has Security Group.",
            groups = {
                    ONE_USER,
                    EVENT,
                    KEYCLOAK
    ...
    public void test() {
        ...
        // Sign in to Audience page as user with Partner role and belonging to Security Group.

        AudiencePage audiencePage = keycloakPage.signInAsAudience(getPartnerWithSecurityGroup());
