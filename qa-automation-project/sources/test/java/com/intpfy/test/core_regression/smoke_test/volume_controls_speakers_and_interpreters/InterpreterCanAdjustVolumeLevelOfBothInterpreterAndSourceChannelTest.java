...
public class InterpreterCanAdjustVolumeLevelOfBothInterpreterAndSourceChannelTest extends BaseWebTest implements WebRtcTest {
    ...
    @Test(
            testName = "Check that interpreter can adjust volume level of both Interpreter and Source channel",
            description = "Interpreter can adjust volume level of Incoming and Outgoing channels.",
            groups = {
                    THREE_USERS,
    ...
    public void test() {
        ...
        // Check that volume level can be increased for Incoming and Outgoing channels.

        webRtcVerifier.assertInterpreterCanIncreaseVolumeLevelForIncomingChannel(secondInterpreterPage, speakerStreamIndex);
        webRtcVerifier.assertInterpreterCanIncreaseVolumeLevelForOutgoingChannel(secondInterpreterPage, firstInterpreterStreamIndex);
