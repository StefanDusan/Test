...
public class RaiseInterpretingVolumeByShortcutTest extends BaseWebTest implements EventTest {
    ...
    @Test(
            testName = "Raise interpreting volume by shortcut",
            description = "Speaker can raise Interpreting (language) channel volume by shortcut.",
            groups = {
                    TWO_USERS,
    ...
    public void test() {
        ...
        // Set Min volume level for Interpreting (language) channel.

        hostPage.setMinVolumeLevelForLanguageChannel();
        ...
        // Set Max volume level for Interpreting (language) channel by shortcut.

        hostPage.setMaxVolumeLevelForLanguageChannelByShortcut();
