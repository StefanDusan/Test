...
public class FloorPassThroughIsNoLongerAppliedWhenIncomingChannelIsChangedToNoneOnSpeakersInterfaceTest extends BaseWebTest implements WebRtcTest {
    ...
    @Test(
            testName = "Floor pass through is no longer applied when incoming channel is changed to none on speaker's interface",
            description = "Floor pass through is no longer applied when Incoming channel is changed to None on Speaker's interface.",
            groups = {
                    THREE_USERS,
    ...
    public void test() {
        ...
        // Select 'None' Interpreting language.
        ...
        secondSpeakerVerifier.assertNoInterpretingLanguageSelected();
