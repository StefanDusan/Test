...
public class LogInWithAccountThatIsNotOnSecurityGroupTest extends BaseWebTest implements KeycloakOrganizationTest {
    ...
    @Test(
            testName = "Log in with account that is not on security group",
            description = "Keycloak user without Partner role and not belonging to Security Group can not Log in to EMI if Security Group added by Organization.",
            groups = {
                    ONE_USER,
                    EMI,
                    KEYCLOAK
