...
public class LogInWithPartnerAccountWhenWhitelistAndSecurityGroupsAreUploadedInEMITest extends BaseWebTest implements KeycloakOrganizationTest {
    ...
    @Test(
            testName = "Log in with partner account when whitelist and security groups are uploaded in EMI",
            description = "Keycloak user with Partner role can Log in to EMI if Allowlist, containing Email different from user's, " +
