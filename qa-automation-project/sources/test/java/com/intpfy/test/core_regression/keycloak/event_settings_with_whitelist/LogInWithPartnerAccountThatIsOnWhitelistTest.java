...
public class LogInWithPartnerAccountThatIsOnWhitelistTest extends BaseWebTest implements KeycloakEventTest {
    ...
    public Event getEvent() {
        ...
        if (event == null) {
            ...
            SamlSecurityGroupSet samlSecurityGroupSet = new SamlSecurityGroupSet.Builder()
                    ...
                    .withAllowlistEmails(partner.getEmail())
                    .build();
    ...
    @Test(
            ...
            description = "Keycloak user with Partner role can Log in to Event if it has Allowlist, containing user Email, and no Security Groups.",
            groups = {
                    ONE_USER,
                    EVENT,
                    KEYCLOAK
    ...
    public void test() {
        ...
        AudiencePage audiencePage = keycloakPage.signInAsAudience(partner);
