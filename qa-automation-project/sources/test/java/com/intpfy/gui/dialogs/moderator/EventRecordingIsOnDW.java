...
public class EventRecordingIsOnDW extends BaseComponent {
    ...
    public EventRecordingIsOnDW(IParent parent) {
        super("'Event recording is on' dialog window", parent,
                By.xpath("//div[@class='modal-content' and .//h4[text()='Event recording is on']]"));
    }
