...
public class WorkOfBackButtonOnDevicesTestPageForInterpreterTest extends BaseWebTest implements EventTest {
    ...
    @Test(
            testName = "[Pre-call Test] Check the work of 'Back' button on devices test page for Interpreter",
            description = "Interpreter can return to 'Login' page by clicking 'Back' button on 'Devices test' page.",
            groups = {
                    ONE_USER,
                    EVENT,
