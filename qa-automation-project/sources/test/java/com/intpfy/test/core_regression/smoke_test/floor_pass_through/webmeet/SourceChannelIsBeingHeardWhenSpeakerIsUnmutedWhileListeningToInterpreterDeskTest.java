...
public class SourceChannelIsBeingHeardWhenSpeakerIsUnmutedWhileListeningToInterpreterDeskTest extends BaseWebTest implements WebRtcTest {
    ...
    @Test(
            testName = "Source channel is being heard when speaker is unmuted while listening to interpreter desk",
            description = "Source channel is being heard when Speaker is Unmuted while listening to Interpreter desk.",
            groups = {
                    THREE_USERS,
    ...
    public void test() {
        ...
        // There should be only 2 statistics tabs:
