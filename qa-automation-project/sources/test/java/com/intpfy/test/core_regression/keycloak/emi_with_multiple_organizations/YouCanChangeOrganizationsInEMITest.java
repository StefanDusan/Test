...
public class YouCanChangeOrganizationsInEMITest extends BaseWebTest implements KeycloakTest {

    private final KeycloakAuthorizer authorizer = KeycloakAuthorizer.getInstance();

    @Test(
            testName = "Check that you can change organizations in EMI",
            description = "Keycloak user having multiple Keycloak Organizations can change them in EMI.",
            groups = {
                    ONE_USER,
                    EMI,
                    KEYCLOAK
